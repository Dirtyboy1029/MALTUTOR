...
# @Author : DirtyBoy 
# @File : training_uncertainty_model.py
...
def Deepdrebin_experiment(val_type,
    ...
    if val_type == 'self_val':
        base_path = 'output/' + data_type + '/' + feature_type + '/' + val_type
...
if __name__ == '__main__':
    ...
    if feature_type == 'drebin':
        ...
        main_ = Seq_experiment
        if feature_type == 'apiseq':
            architecture_type = 'droidectc'
        elif feature_type == 'opcodeseq':
            architecture_type = 'text_cnn'
        else:
            architecture_type = ''
    main_(val_type, data_type, feature_type=feature_type, architecture_type=architecture_type)
